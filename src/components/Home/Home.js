    ...
    return (
       <div className="Home">
         <div className="col-md-8 mx-auto">
           ...
           <button className="btn btn-secondary year m-2" onClick={this.toggleYear}>All</button>
           <button className="btn btn-secondary year m-2" onClick={this.toggleYear}>2013</button>
           <button className="btn btn-secondary year m-2" onClick={this.toggleYear}>2014</button>
           <button className="btn btn-secondary year m-2" onClick={this.toggleYear}>2015</button>
           <button className="btn btn-secondary year m-2" onClick={this.toggleYear}>2016</button>
           <button className="btn btn-secondary year m-2" onClick={this.toggleYear}>2017</button>
           <button className="btn btn-secondary year m-2" onClick={this.toggleYear}>2018</button>
         </div>
